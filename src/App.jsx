...
export default function SunSmartUIMockup() {
            ...
            <div className="grid gap-4 lg:grid-cols-[1fr_1fr]">
              ...
              <Card className="rounded-[28px] border-white/60 bg-white/75 shadow-sm">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
  {/* Instagram */}
  <Button className="rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white hover:opacity-90"
    onClick={() => {
  ...
  {/* Facebook */}
  <Button className="rounded-xl bg-[#1877F2] text-white hover:bg-[#1665d8]"
    onClick={() => {
  ...
  {/* Twitter/X */}
  <Button className="rounded-xl bg-slate-900 text-white hover:bg-slate-700"
    onClick={() => {
